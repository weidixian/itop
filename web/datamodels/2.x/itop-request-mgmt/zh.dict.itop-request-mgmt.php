...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:UserRequest/Attribute:origin/Value:weixin' => '微信',
	'Class:UserRequest/Attribute:origin/Value:weixin+' => '微信',
	'Class:UserRequest/Attribute:origin/Value:qq' => 'QQ',
	'Class:UserRequest/Attribute:origin/Value:qq+' => 'QQ',
	'Class:UserRequest/Attribute:origin/Value:dingtalk' => '钉钉',
	'Class:UserRequest/Attribute:origin/Value:dingtalk+' => '钉钉',
	...
	'Class:UserRequest/Attribute:resolution_code/Value:training+' => '培训',
	'Class:UserRequest/Attribute:resolution_code/Value:cancel' => '无效作废',
	'Class:UserRequest/Attribute:resolution_code/Value:cancel+' => '无效作废',
	...
	'Class:UserRequest/Error:CannotAssignParentRequestIdToSelf' => '不能分配父级需求分配给自己',
));
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Portal:Button:CreateRequestFromService' => '创建一个服务需求',
	...
	'Class:UserRequest/Method:ResolveChildTickets' => '解决子Ticket',
