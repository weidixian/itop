...
<ul>它包括:
<li>完整的CMDB(Configuration management database)，用于登记和管理IT 资产.</li>
...
<p>所有模块可以各自独立地、一步一步地部署.</p>',
	...
	'UI:WelcomeMenu:RightBlock' => '<p>iTop是面向服务供应商的, 它使得IT工程师更方便地管理多客户和多组织.
...
<li>管理中最重要的资产: 文档化.</li>
	...
	'UI:ResetPwd-Error-InvalidToken' => '对不起, either the password has already been reset, or you have received several emails. Please make sure that you use the link provided in the very last email received.',
...
当与一个触发器关联时, 每个操作都被赋予一个顺序号, 规定了按什么样的顺序执行这些操作.</p>',
	...
	'Portal:NoRequestMgmt' => '尊敬的 %1$s, 您被重定向到这个页面,因为您的账户已被设置成角色 \'Portal user\'. Unfortunately, iTop has not been installed with the feature \'Request Management\'. 请联系您的管理员.',
	'Portal:Refresh' => '刷新',
	'Portal:Back' => '返回',
	...
	'UI:FavoriteOrganizations+' => '为了通过下拉菜单快速访问，请检查下面您想看到的的组织列表. '.
	...
	'UI:Favorites:ShowObsoleteData' => '显示旧数据',
