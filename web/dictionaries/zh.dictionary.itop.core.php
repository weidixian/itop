...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:TriggerOnPortalUpdate' => '触发器 (when updated from the portal)',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:TriggerOnStateChange' => '触发器 (on state change)',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:TriggerOnStateEnter' => '触发器 (on entering a state)',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:TriggerOnStateLeave' => '触发器 (on leaving a state)',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:TriggerOnObjectCreate' => '触发器 (on object creation)',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	'Class:TriggerOnThresholdReached' => '触发器 (on threshold)',
...
Dict::Add('ZH CN', 'Chinese', '简体中文', array(
	...
	'Class:SynchroDataSource/Attribute:status/Value:implementation' => '施行',
	...
	'Class:SynchroDataSource/Attribute:action_on_multiple/Value:take_first' => '选择第一个(随机?)',
	...
	'Core:BulkExport:DragAndDropHelp' => '拖放列表的头部来调整顺序.正在 预览其中的 %1$s 行. 一共需要导出的行数为: %2$s.',
	'Core:BulkExport:EmptyPreview' => '从上面的列表中选择需要导出的列',
	...
	'Core:BulkExport:TextFormat' => '文本字段包含一些 HTML 标记',
